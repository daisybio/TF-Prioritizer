...
def main():
	...
	parser.add_argument("scaled",nargs=1,help="Flag indicating whether scaled affinity features should be used", default="False")
	parser.add_argument("peakFeatures",nargs=1,help="Flag indicating whether peakFeatures should be used", default="False")
	parser.add_argument("tpmFilter",nargs=1,help="Flag indicating whether TPM filter should be used", default="False")
