...
public class atac_seq_download_convert_sort_identify_remove
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        atac_seq_download_cancer_blocks tgct = new atac_seq_download_cancer_blocks();
        {
            ...
            tgct.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/TGCT/METADATA/gdc_sample_sheet.2021-07-16.tsv";
            tgct.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/TGCT/METADATA/clinical.cart.2021-07-16/clinical.tsv";
        ...
        atac_seq_download_cancer_blocks blca = new atac_seq_download_cancer_blocks();
        {
            blca.name = "BLCA";
            blca.input_manifest =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BLCA/META_DATA/ATAC_SEQ/gdc_manifest_20210720_141715.txt";
            blca.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BLCA/META_DATA/ATAC_SEQ/clinical.cart.2021-07-20/clinical.tsv";
            blca.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BLCA/META_DATA/ATAC_SEQ/gdc_sample_sheet.2021-07-20.tsv";
        ...
        atac_seq_download_cancer_blocks brca = new atac_seq_download_cancer_blocks();
        {
            ...
            brca.name = "03_BRCA";
            brca.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/03_BRCA/METADATA/ATAC_SEQ/gdc_manifest_20210721_125249.txt";
            brca.input_clinical = "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/03_BRCA/METADATA/ATAC_SEQ/clinical.tsv";
            brca.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/03_BRCA/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-30.tsv";
        ...
        atac_seq_download_cancer_blocks coad = new atac_seq_download_cancer_blocks();
        {
            ...
            coad.name = "04_COAD";
            coad.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/04_COAD/METADATA/ATAC_SEQ/gdc_manifest_20210722_083841.txt";
            coad.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/04_COAD/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            coad.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/04_COAD/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks kirp = new atac_seq_download_cancer_blocks();
        {
            ...
            kirp.name = "05_KIRP";
            kirp.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/05_KIRP/METADATA/ATAC_SEQ/gdc_manifest_20210722_084501.txt";
            kirp.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/05_KIRP/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            kirp.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/05_KIRP/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks prad = new atac_seq_download_cancer_blocks();
        {
            ...
            prad.name = "06_PRAD";
            prad.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/06_PRAD/METADATA/ATAC_SEQ/gdc_manifest_20210722_084614.txt";
            prad.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/06_PRAD/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            prad.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/06_PRAD/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks luad = new atac_seq_download_cancer_blocks();
        {
            ...
            luad.name = "07_LUAD";
            luad.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/07_LUAD/METADATA/ATAC_SEQ/gdc_manifest_20210722_084723.txt";
            luad.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/07_LUAD/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            luad.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/07_LUAD/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks stad = new atac_seq_download_cancer_blocks();
        {
            ...
            stad.name = "08_STAD";
            stad.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/08_STAD/METADATA/ATAC_SEQ/gdc_manifest_20210722_084854.txt";
            stad.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/08_STAD/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            stad.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/08_STAD/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks esca = new atac_seq_download_cancer_blocks();
        {
            ...
            esca.name = "09_ESCA";
            esca.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/09_ESCA/METADATA/ATAC_SEQ/gdc_manifest_20210722_084954.txt";
            esca.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/09_ESCA/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            esca.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/09_ESCA/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks lihc = new atac_seq_download_cancer_blocks();
        {
            ...
            lihc.name = "10_LIHC";
            lihc.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/10_LIHC/METADATA/ATAC_SEQ/gdc_manifest_20210722_085059.txt";
            lihc.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/10_LIHC/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            lihc.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/10_LIHC/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks kirc = new atac_seq_download_cancer_blocks();
        {
            ...
            kirc.name = "11_KIRC";
            kirc.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/11_KIRC/METADATA/ATAC_SEQ/gdc_manifest_20210722_085201.txt";
            kirc.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/11_KIRC/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            kirc.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/11_KIRC/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks lusc = new atac_seq_download_cancer_blocks();
        {
            ...
            lusc.name = "12_LUSC";
            lusc.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/12_LUSC/METADATA/ATAC_SEQ/gdc_manifest_20210722_085303.txt";
            lusc.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/12_LUSC/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            lusc.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/12_LUSC/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks thca = new atac_seq_download_cancer_blocks();
        {
            ...
            thca.name = "13_THCA";
            thca.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/13_THCA/METADATA/ATAC_SEQ/gdc_manifest_20210722_085403.txt";
            thca.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/13_THCA/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            thca.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/13_THCA/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks lgg = new atac_seq_download_cancer_blocks();
        {
            ...
            lgg.name = "14_LGG";
            lgg.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/14_LGG/METADATA/ATAC_SEQ/gdc_manifest_20210722_085513.txt";
            lgg.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/14_LGG/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            lgg.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/14_LGG/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks skcm = new atac_seq_download_cancer_blocks();
        {
            ...
            skcm.name = "15_SKCM";
            skcm.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/15_SKCM/METADATA/ATAC_SEQ/gdc_manifest_20210722_085610.txt";
            skcm.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/15_SKCM/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            skcm.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/15_SKCM/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks ucec = new atac_seq_download_cancer_blocks();
        {
            ...
            ucec.name = "16_UCEC";
            ucec.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/16_UCEC/METADATA/ATAC_SEQ/gdc_manifest_20210722_085753.txt";
            ucec.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/16_UCEC/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            ucec.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/16_UCEC/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks acc = new atac_seq_download_cancer_blocks();
        {
            ...
            acc.name = "17_ACC";
            acc.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/17_ACC/METADATA/ATAC_SEQ/gdc_manifest_20210722_085849.txt";
            acc.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/17_ACC/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            acc.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/17_ACC/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks gbm = new atac_seq_download_cancer_blocks();
        {
            ...
            gbm.name = "18_GBM";
            gbm.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/18_GBM/METADATA/ATAC_SEQ/gdc_manifest_20210722_085953.txt";
            gbm.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/18_GBM/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            gbm.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/18_GBM/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks hnsc = new atac_seq_download_cancer_blocks();
        {
            ...
            hnsc.name = "19_HNSC";
            hnsc.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/19_HNSC/METADATA/ATAC_SEQ/gdc_manifest_20210722_090106.txt";
            hnsc.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/19_HNSC/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            hnsc.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/19_HNSC/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks pcpg = new atac_seq_download_cancer_blocks();
        {
            ...
            pcpg.name = "20_PCPG";
            pcpg.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/20_PCPG/METADATA/ATAC_SEQ/gdc_manifest_20210722_090212.txt";
            pcpg.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/20_PCPG/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            pcpg.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/20_PCPG/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks meso = new atac_seq_download_cancer_blocks();
        {
            ...
            meso.name = "21_MESO";
            meso.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/21_MESO/METADATA/ATAC_SEQ/gdc_manifest_20210722_090309.txt";
            meso.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/21_MESO/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            meso.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/21_MESO/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks chol = new atac_seq_download_cancer_blocks();
        {
            ...
            chol.name = "22_CHOL";
            chol.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/22_CHOL/METADATA/ATAC_SEQ/gdc_manifest_20210722_090359.txt";
            chol.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/22_CHOL/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            chol.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/22_CHOL/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
        ...
        atac_seq_download_cancer_blocks cesc = new atac_seq_download_cancer_blocks();
        {
            ...
            cesc.name = "23_CESC";
            cesc.input_manifest =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/23_CESC/METADATA/ATAC_SEQ/gdc_manifest_20210722_090450.txt";
            cesc.input_clinical =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/23_CESC/METADATA/ATAC_SEQ/clinical.cart.2021-07-22/clinical.tsv";
            cesc.input_gdc_sample_sheet =
                    "/nfs/data/COM2POSE/TCGA/08_TCGA_ATAC_SEQ/23_CESC/METADATA/ATAC_SEQ/gdc_sample_sheet.2021-07-22.tsv";
    ...
    public static void execute_all(atac_seq_download_cancer_blocks block) throws Exception
    {
        ...
        File f_output_dir_raw_data =
                new File(f_output_directory_atac_seq.getAbsolutePath() + File.separator + "01_raw_data");
        f_output_dir_raw_data.mkdirs();
        File f_output_dir_sorted_data =
                new File(f_output_directory_atac_seq.getAbsolutePath() + File.separator + "02_sorted_data");
        f_output_dir_sorted_data.mkdirs();
        File f_output_dir_sorted_data_gapped =
                new File(f_output_directory_atac_seq.getAbsolutePath() + File.separator + "03_sorted_data_gapped");
        f_output_dir_sorted_data_gapped.mkdirs();
        File f_output_dir_sorted_data_rscript =
                new File(f_output_directory_atac_seq.getAbsolutePath() + File.separator + "04_sorted_data_rscript");
        f_output_dir_sorted_data_rscript.mkdirs();
        File f_output_dir_sorted_data_allpeaks =
                new File(f_output_directory_atac_seq.getAbsolutePath() + File.separator + "05_sorted_data_allpeaks");
        ...
        execute_sorting(input_gdc_sample_sheet, input_clinical, f_output_directory, f_output_dir_raw_data,
                f_output_dir_sorted_data, f_output_dir_sorted_data_gapped, groups, other_samples,
                f_output_dir_sorted_data_rscript, f_output_dir_sorted_data_allpeaks);
    ...
    private static void execute_sorting(String input_gdc_sample_sheet, String input_clinical, File f_output_directory,
                                        ...
                                        File f_output_dir_sorted_data_allpeaks) throws Exception
    {
        ...
        for (String k_groups : groups)
        {
            ...
            File f_out_gapped_parent =
                    new File(f_output_dir_sorted_data_gapped.getAbsolutePath() + File.separator + k_groups);
            f_out_gapped_parent.mkdirs();

            File f_out_gapped = new File(f_out_gapped_parent.getAbsolutePath() + File.separator + "ATAC_SEQ");
            f_out_gapped.mkdirs();

            File f_out_rscript_parent =
                    new File(f_output_dir_sorted_data_rscript.getAbsolutePath() + File.separator + k_groups);
            ...
            File f_out_allpeaks_parent =
                    new File(f_output_dir_sorted_data_allpeaks.getAbsolutePath() + File.separator + k_groups);
        ...
        File f_out_sorted_data_parent =
                new File(f_output_dir_sorted_data.getAbsolutePath() + File.separator + other_samples);
        f_out_sorted_data_parent.mkdirs();
        ...
        File f_out_gapped_parent =
                new File(f_output_dir_sorted_data_gapped.getAbsolutePath() + File.separator + other_samples);
        f_out_gapped_parent.mkdirs();
        ...
        File f_out_rscript_parent =
                new File(f_output_dir_sorted_data_rscript.getAbsolutePath() + File.separator + other_samples);
        f_out_rscript_parent.mkdirs();
        ...
        File f_out_allpeaks_parent =
                new File(f_output_dir_sorted_data_allpeaks.getAbsolutePath() + File.separator + other_samples);
        f_out_allpeaks_parent.mkdirs();
                            ...
                            for (File f_macs2_outputs : f_macs2_files.listFiles())
                            {
                                ...
                                if (name_f_move.matches(".*broadPeak.*"))
                                {
                                    ...
                                    if (other_sample_here)
                                    {
                                        ...
                                        command_move += f_out_sorted_data.getAbsolutePath() + File.separator +
                                    ...
                                    } else
                                    {
                                        ...
                                        command_move += f_output_group.getAbsolutePath() + File.separator +
                                                f_macs2_outputs.getName() + " " + f_output_group.getAbsolutePath() +
                                                File.separator + f_name_moved;
                                ...
                                if (name_f_move.matches(".*gappedPeak.*"))
                                {
                                    ...
                                    if (other_sample_here)
                                    {
                                        ...
                                        command_move += f_out_gapped.getAbsolutePath() + File.separator +
                                ...
                                if (name_f_move.matches(".*_model.*"))
                                {
                                    ...
                                    if (other_sample_here)
                                    {
                                        ...
                                        command_move += f_out_rscript.getAbsolutePath() + File.separator +
                                                f_macs2_outputs.getName() + " " + f_out_rscript.getAbsolutePath() +
                                                File.separator + f_name_moved;
                                ...
                                if (name_f_move.matches(".*_peaks.xls.*"))
                                {
                                    ...
                                    if (other_sample_here)
                                    {
                                        ...
                                        command_move += f_out_allpeaks.getAbsolutePath() + File.separator +
                                                f_macs2_outputs.getName() + " " + f_out_allpeaks.getAbsolutePath() +
                                                File.separator + f_name_moved;
    ...
    private static void execute_peak_calling(File f_output_dir_raw_data) throws Exception
    {
        ...
        String command_edited = "find " + f_output_dir_raw_data.getAbsolutePath() +
                " -name \\*.bam -exec sh -c 'echo {}; macs2 callpeak --broad -t {} --outdir {}_file --format BAM' \\;";
                                         ...
                                         String input_token, String name) throws Exception
    {
        ...
        String command_edited = input_gdc_client + " download -m " + input_manifest + " --log-file " +
                f_input_manifest.getParentFile().getAbsolutePath() + File.separator + name + "_logfile.txt -t " +
                input_token + " -d " + f_output_dir_raw_data.getAbsolutePath();
