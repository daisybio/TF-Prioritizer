...
public class rna_seq_unpack_sort
{
    ...
    public static String input_directory_biogrid_entrez =
            "/home/markus/Dropbox/UNI/Promotion_Projekte/PhD_work/H_ATAC_SEQ/PCA/olga_analysis/biogrid.human.entrez.tsv";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        atac_seq_download_cancer_blocks block_tgct = new atac_seq_download_cancer_blocks();
        {
            ...
            block_tgct.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/TGCT/RNA_SEQ/01_raw/gdc_download_20210810_132716.957271";
            block_tgct.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/TGCT/METADATA/RNA_SEQ/clinical.cart.2021-08-10/clinical.tsv";
            block_tgct.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/TGCT/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-10.tsv";
        ...
        atac_seq_download_cancer_blocks block_BLCA = new atac_seq_download_cancer_blocks();
        {
            ...
            block_BLCA.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BLCA/RNA_SEQ/gdc_download_20210811_064600.308234";
            block_BLCA.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BLCA/META_DATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_BLCA.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BLCA/META_DATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_BRCA = new atac_seq_download_cancer_blocks();
        {
            ...
            block_BRCA.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BRCA/RNA_SEQ/01_raw/gdc_download_20210806_054044.782364";
            block_BRCA.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BRCA/META_DATA/RNA_SEQ/clinical.cart.2021-08-06/clinical.tsv";
            block_BRCA.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/03_BRCA/META_DATA/RNA_SEQ/gdc_sample_sheet.2021-08-06.tsv";
        ...
        atac_seq_download_cancer_blocks block_COAD = new atac_seq_download_cancer_blocks();
        {
            ...
            block_COAD.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/04_COAD/RNA_SEQ/01_raw/gdc_download_20210811_064850.270781";
            block_COAD.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/04_COAD/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_COAD.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/04_COAD/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_KIRP = new atac_seq_download_cancer_blocks();
        {
            ...
            block_KIRP.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/05_KIRP/RNA_SEQ/01_raw/gdc_download_20210811_065137.607520";
            block_KIRP.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/05_KIRP/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_KIRP.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/05_KIRP/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_PRAD = new atac_seq_download_cancer_blocks();
        {
            ...
            block_PRAD.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/06_PRAD/RNA_SEQ/01_raw/gdc_download_20210811_065355.069019";
            block_PRAD.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/06_PRAD/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_PRAD.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/06_PRAD/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_LUAD = new atac_seq_download_cancer_blocks();
        {
            ...
            block_LUAD.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/07_LUAD/RNA_SEQ/01_raw/gdc_download_20210811_071055.539794";
            block_LUAD.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/07_LUAD/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_LUAD.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/07_LUAD/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_STAD = new atac_seq_download_cancer_blocks();
        {
            ...
            block_STAD.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/08_STAD/RNA_SEQ/01_raw/gdc_download_20210811_065952.752534";
            block_STAD.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/08_STAD/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_STAD.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/08_STAD/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_ESCA = new atac_seq_download_cancer_blocks();
        {
            ...
            block_ESCA.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/09_ESCA/RNA_SEQ/01_raw/gdc_download_20210811_070227.439914";
            block_ESCA.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/09_ESCA/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_ESCA.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/09_ESCA/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_LIHC = new atac_seq_download_cancer_blocks();
        {
            ...
            block_LIHC.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/10_LIHC/RNA_SEQ/01_raw/gdc_download_20210811_071408.358464";
            block_LIHC.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/10_LIHC/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_LIHC.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/10_LIHC/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_KIRC = new atac_seq_download_cancer_blocks();
        {
            ...
            block_KIRC.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/11_KIRC/RNA_SEQ/01_raw/gdc_download_20210811_071630.749633";
            block_KIRC.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/11_KIRC/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_KIRC.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/11_KIRC/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_LUSC = new atac_seq_download_cancer_blocks();
        {
            ...
            block_LUSC.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/12_LUSC/RNA_SEQ/01_raw/gdc_download_20210811_071834.296668";
            block_LUSC.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/12_LUSC/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_LUSC.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/12_LUSC/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_THCA = new atac_seq_download_cancer_blocks();
        {
            ...
            block_THCA.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/13_THCA/RNA_SEQ/01_raw/gdc_download_20210811_072143.524926";
            block_THCA.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/13_THCA/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_THCA.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/13_THCA/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_LGG = new atac_seq_download_cancer_blocks();
        {
            ...
            block_LGG.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/14_LGG/RNA_SEQ/01_raw/gdc_download_20210811_072408.947445";
            block_LGG.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/14_LGG/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_LGG.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/14_LGG/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_SKCM = new atac_seq_download_cancer_blocks();
        {
            ...
            block_SKCM.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/15_SKCM/RNA_SEQ/01_raw/gdc_download_20210811_072645.075074";
            block_SKCM.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/15_SKCM/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_SKCM.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/15_SKCM/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_UCEC = new atac_seq_download_cancer_blocks();
        {
            ...
            block_UCEC.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/16_UCEC/RNA_SEQ/01_raw/gdc_download_20210811_072934.082004";
            block_UCEC.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/16_UCEC/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_UCEC.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/16_UCEC/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_ACC = new atac_seq_download_cancer_blocks();
        {
            ...
            block_ACC.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/17_ACC/RNA_SEQ/01_raw/gdc_download_20210811_073135.623128";
            block_ACC.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/17_ACC/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_ACC.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/17_ACC/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_HNSC = new atac_seq_download_cancer_blocks();
        {
            ...
            block_HNSC.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/19_HNSC/RNA_SEQ/01_raw/gdc_download_20210811_073652.791948";
            block_HNSC.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/19_HNSC/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_HNSC.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/19_HNSC/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_PCPG = new atac_seq_download_cancer_blocks();
        {
            ...
            block_PCPG.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/20_PCPG/RNA_SEQ/01_raw/gdc_download_20210811_073906.011732";
            block_PCPG.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/20_PCPG/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_PCPG.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/20_PCPG/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_MESO = new atac_seq_download_cancer_blocks();
        {
            ...
            block_MESO.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/21_MESO/RNA_SEQ/01_raw/gdc_download_20210811_074127.501831";
            block_MESO.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/21_MESO/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_MESO.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/21_MESO/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_CHOL = new atac_seq_download_cancer_blocks();
        {
            ...
            block_CHOL.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/22_CHOL/RNA_SEQ/01_raw/gdc_download_20210811_074351.486592";
            block_CHOL.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/22_CHOL/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_CHOL.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/22_CHOL/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
        ...
        atac_seq_download_cancer_blocks block_CESC = new atac_seq_download_cancer_blocks();
        {
            ...
            block_CESC.input_dir_root =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/23_CESC/RNA_SEQ/01_raw/gdc_download_20210811_074548.241451";
            block_CESC.input_clinical =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/23_CESC/METADATA/RNA_SEQ/clinical.cart.2021-08-11/clinical.tsv";
            block_CESC.input_gdc_sample_sheet =
                    "/home/markus/data/COM2POSE/08_TCGA_ATAC_SEQ/23_CESC/METADATA/RNA_SEQ/gdc_sample_sheet.2021-08-11.tsv";
    ...
    private static void execute_all(atac_seq_download_cancer_blocks blocks) throws Exception
    {
        ...
        if (action.equals("ANALYSE"))
        {
            ...
            {
                System.out.println(
                        "[ERROR] mapping does not exist - action EXECUTE has to be done first!" + blocks.name);
                return;
            }
        ...
        } else if (action.equals("EXECUTE"))
        {
            ...
            sort(f_input_root, f_output_sorted_root, f_output_rnaseq_sorted, blocks.groups, blocks.other_samples,
                    f_input_clinical, f_input_sample_sheet, f_output_mapping, ident_folder, f_output_rnaseq_sorted,
                    f_output_rnaseq_formatted, f_output_pca);
     ...
     * @throws IOException
     */
    private static HashMap<String, HashSet<String>> analyse_it(File f_output_mapping, String which_ident)
            throws IOException
    {
    ...
    private static boolean perform_pca(File f_output_rnaseq_sorted, File f_output_pca,
                                       atac_seq_download_cancer_blocks blocks) throws Exception
    {
        ...
        File f_plot_heatmap =
                new File(f_output_pca.getAbsolutePath() + File.separator + blocks.name + "_heatmap_plot.png");
        ...
        sb_python_script.append(
                "import pandas as pd\n" + "import matplotlib.pyplot as plt\n" + "\n" + "\n" + "path=\"" +
                        f_output_rnaseq_sorted.getAbsolutePath() + "\"\n" + "\n" + "import os\n" +
        ...
        sb_python_script.append(
                "out = mg.querymany(norm.index, scopes='ensemblgene', fields='entrezgene', species=\"human\", verbose=False, \n" +
        ...
        sb_python_script.append(
                "path_expr,path_net ='" + f_data_norm.getAbsolutePath() + "', '" + input_directory_biogrid_entrez +
                        "'\n");
        ...
        sb_python_script.append(
                "pca = PCA(n_components=" + blocks.number_groups + ")\n" + "components = pca.fit_transform(norm.T)\n");
    ...
    private static void format_even_ensgs(File f_output_rnaseq_sorted, File f_output_rnaseq_formatted)
            throws IOException
    {
        ...
        for (File f_sorted : f_output_rnaseq_sorted.listFiles())
        {
            ...
            {
                File f_output =
                        new File(f_output_rnaseq_formatted.getAbsolutePath() + File.separator + f_sorted.getName());
                f_output.mkdirs();
        ...
        File f_output_names_formatted =
                new File(f_output_rnaseq_formatted.getAbsolutePath() + File.separator + "names_formatted.txt");
    ...
    private static void format_uneven_ensgs(File f_output_rnaseq_sorted, File f_output_rnaseq_formatted)
            throws IOException
    {
    ...
    private static void sort(File f_input_root, File f_output_sorted_root, File f_output_rnaseq, HashSet<String> groups,
                             String other_samples, File f_input_clinical, File f_input_gdc_sample_sheet,
                             File f_output_mapping, HashMap<String, HashSet<String>> ident_folder,
                             File f_output_rnaseq_sorted, File f_output_rnaseq_formatted, File f_output_pca)
            throws Exception
    {
        ...
        if (!ident_folder.isEmpty() && !execute_option.equals(""))
        {
            ...
            File f_output_old = new File(
                    f_output_sorted_root.getAbsolutePath() + File.separator + "RNA_SEQ" + File.separator +
                            "old_before_" + execute_option);
            f_output_old.mkdir();
        ...
        sb_mappings.append(
                "sample_name\tcase_submitter_id\tcase_ID\tgdc_fileID\tgdc_file_name\tsubtype\tspecific_subtype\tsample_id\n");
            ...
            if (f_file_id.isDirectory())
            {
                ...
                for (File f_intern : f_file_id.listFiles())
                {
                    if (f_intern.isFile())
                    {
                        ...
                        {
                            File f_output_dir =
                                    new File(f_output_rnaseq.getAbsolutePath() + File.separator + subtype_formatted);
                            ...
                            command_move += f_output_dir.getAbsolutePath() + File.separator + f_intern.getName() + " " +
                                    f_output_dir.getAbsolutePath() + File.separator + move_name;
                        } else
                        {
                            File f_output_dir =
                                    new File(f_output_rnaseq.getAbsolutePath() + File.separator + subtype_formatted);
    ...
    private static boolean unpack(File input_root) throws Exception
    {
        ...
        String command_edited =
                "find " + input_root.getAbsolutePath() + " -name \\*.gz -exec sh -c 'echo {}; gzip -d {}' \\;";
