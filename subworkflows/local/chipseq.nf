...
ch_multiqc_config        = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc_config.yml", checkIfExists: true)
...
ch_spp_rsc_header           = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc/spp_rsc_header.txt", checkIfExists: true)
ch_spp_correlation_header   = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc/spp_correlation_header.txt", checkIfExists: true)
ch_peak_count_header        = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc/peak_count_header.txt", checkIfExists: true)
ch_frip_score_header        = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc/frip_score_header.txt", checkIfExists: true)
ch_peak_annotation_header   = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc/peak_annotation_header.txt", checkIfExists: true)
ch_deseq2_pca_header        = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc/deseq2_pca_header.txt", checkIfExists: true)
ch_deseq2_clustering_header = file("$projectDir/subworkflows/nf-core/chipseq/assets/multiqc/deseq2_clustering_header.txt", checkIfExists: true)
...
workflow CHIPSEQ {
    ...
    //
    if (params.chipseq_aligner == 'bowtie2') {
        ALIGN_BOWTIE2 (
            FASTQC_TRIMGALORE.out.reads,
    ...
    //
    if (params.chipseq_aligner == 'chromap') {
        ALIGN_CHROMAP (
            FASTQC_TRIMGALORE.out.reads,
    ...
    //
    if (params.chipseq_aligner == 'star') {
        ALIGN_STAR (
            FASTQC_TRIMGALORE.out.reads,
