...
checkPathParamList = [
    params.rnaseq_samplesheet, params.multiqc_config,
    params.fasta, params.transcript_fasta, params.additional_fasta,
    params.gtf, params.gff, params.gene_bed,
    params.rnaseq_ribo_database_manifest, params.splicesites,
    params.star_index, params.hisat2_index, params.rsem_index, params.salmon_index
]
for (param in checkPathParamList) { if (param) { file(param, checkIfExists: true) } }

// Check mandatory parameters
if (params.rnaseq_samplesheet) { ch_input = file(params.rnaseq_samplesheet) } else { exit 1, 'Input samplesheet not specified!' }

// Check rRNA databases for sortmerna
if (params.rnaseq_remove_ribo_rna) {
    ch_ribo_db = file(params.rnaseq_ribo_database_manifest, checkIfExists: true)
    if (ch_ribo_db.isEmpty()) {exit 1, "File provided with --ribo_database_manifest is empty: ${ch_ribo_db.getName()}!"}
}

// Check if file with list of fastas is provided when running BBSplit
if (!params.rnaseq_skip_bbsplit && !params.bbsplit_index && params.rnaseq_bbsplit_fasta_list) {
    ch_bbsplit_fasta_list = file(params.rnaseq_bbsplit_fasta_list, checkIfExists: true)
...
ch_multiqc_config          = Channel.fromPath("$projectDir/subworkflows/nf-core/rnaseq/assets/multiqc_config.yml", checkIfExists: true)
ch_multiqc_custom_config   = params.multiqc_config ? Channel.fromPath( params.multiqc_config, checkIfExists: true ) : Channel.empty()
ch_multiqc_logo            = params.multiqc_logo   ? Channel.fromPath( params.multiqc_logo, checkIfExists: true ) : Channel.empty()
ch_multiqc_custom_methods_description = params.multiqc_methods_description ? file(params.multiqc_methods_description, checkIfExists: true) : file("$projectDir/assets/methods_description_template.yml", checkIfExists: true)

// Header files for MultiQC
ch_pca_header_multiqc        = file("$projectDir/subworkflows/nf-core/rnaseq/assets/multiqc/deseq2_pca_header.txt", checkIfExists: true)
ch_clustering_header_multiqc = file("$projectDir/subworkflows/nf-core/rnaseq/assets/multiqc/deseq2_clustering_header.txt", checkIfExists: true)
ch_biotypes_header_multiqc   = file("$projectDir/subworkflows/nf-core/rnaseq/assets/multiqc/biotypes_header.txt", checkIfExists: true)
...
//
include { BEDTOOLS_GENOMECOV                 } from '../nf-core/rnaseq/modules/local/bedtools_genomecov'
include { DESEQ2_QC as DESEQ2_QC_STAR_SALMON } from '../nf-core/rnaseq/modules/local/deseq2_qc'
include { DESEQ2_QC as DESEQ2_QC_RSEM        } from '../nf-core/rnaseq/modules/local/deseq2_qc'
include { DESEQ2_QC as DESEQ2_QC_SALMON      } from '../nf-core/rnaseq/modules/local/deseq2_qc'
include { DUPRADAR                           } from '../nf-core/rnaseq/modules/local/dupradar'
include { MULTIQC                            } from '../nf-core/rnaseq/modules/local/multiqc'
include { MULTIQC_CUSTOM_BIOTYPE             } from '../nf-core/rnaseq/modules/local/multiqc_custom_biotype'
include { UMITOOLS_PREPAREFORRSEM as UMITOOLS_PREPAREFORSALMON } from '../nf-core/rnaseq/modules/local/umitools_prepareforrsem.nf'
...
include { QUANTIFY_SALMON as QUANTIFY_STAR_SALMON } from '../nf-core/rnaseq/subworkflows/local/quantify_salmon'
include { QUANTIFY_SALMON as QUANTIFY_SALMON      } from '../nf-core/rnaseq/subworkflows/local/quantify_salmon'
...
//
include { CAT_FASTQ                   } from '../nf-core/rnaseq/modules/nf-core/cat/fastq/main'
include { BBMAP_BBSPLIT               } from '../nf-core/rnaseq/modules/nf-core/bbmap/bbsplit/main'
include { SAMTOOLS_SORT               } from '../nf-core/rnaseq/modules/nf-core/samtools/sort/main'
include { PRESEQ_LCEXTRAP             } from '../nf-core/rnaseq/modules/nf-core/preseq/lcextrap/main'
include { QUALIMAP_RNASEQ             } from '../nf-core/rnaseq/modules/nf-core/qualimap/rnaseq/main'
include { SORTMERNA                   } from '../nf-core/rnaseq/modules/nf-core/sortmerna/main'
include { STRINGTIE_STRINGTIE         } from '../nf-core/rnaseq/modules/nf-core/stringtie/stringtie/main'
include { SUBREAD_FEATURECOUNTS       } from '../nf-core/rnaseq/modules/nf-core/subread/featurecounts/main'
include { CUSTOM_DUMPSOFTWAREVERSIONS } from '../nf-core/rnaseq/modules/nf-core/custom/dumpsoftwareversions/main'

//
// SUBWORKFLOW: Consisting entirely of nf-core/modules
//
include { FASTQ_SUBSAMPLE_FQ_SALMON        } from '../nf-core/rnaseq/subworkflows/nf-core/fastq_subsample_fq_salmon/main'
include { FASTQ_FASTQC_UMITOOLS_TRIMGALORE } from '../nf-core/rnaseq/subworkflows/nf-core/fastq_fastqc_umitools_trimgalore/main'
include { FASTQ_FASTQC_UMITOOLS_FASTP      } from '../nf-core/rnaseq/subworkflows/nf-core/fastq_fastqc_umitools_fastp/main'
include { FASTQ_ALIGN_HISAT2               } from '../nf-core/rnaseq/subworkflows/nf-core/fastq_align_hisat2/main'
include { BAM_SORT_STATS_SAMTOOLS          } from '../nf-core/rnaseq/subworkflows/nf-core/bam_sort_stats_samtools/main'
include { BAM_MARKDUPLICATES_PICARD        } from '../nf-core/rnaseq/subworkflows/nf-core/bam_markduplicates_picard/main'
include { BAM_RSEQC                        } from '../nf-core/rnaseq/subworkflows/nf-core/bam_rseqc/main'
include { BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS as BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS_GENOME        } from '../nf-core/rnaseq/subworkflows/nf-core/bam_dedup_stats_samtools_umitools/main'
include { BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS as BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS_TRANSCRIPTOME } from '../nf-core/rnaseq/subworkflows/nf-core/bam_dedup_stats_samtools_umitools/main'
include { BEDGRAPH_BEDCLIP_BEDGRAPHTOBIGWIG as BEDGRAPH_BEDCLIP_BEDGRAPHTOBIGWIG_FORWARD } from '../nf-core/rnaseq/subworkflows/nf-core/bedgraph_bedclip_bedgraphtobigwig/main'
include { BEDGRAPH_BEDCLIP_BEDGRAPHTOBIGWIG as BEDGRAPH_BEDCLIP_BEDGRAPHTOBIGWIG_REVERSE } from '../nf-core/rnaseq/subworkflows/nf-core/bedgraph_bedclip_bedgraphtobigwig/main'
...
workflow RNASEQ {
    ...
    PREPARE_GENOME (
        ...
        params.gene_bed,
        params.splicesites,
        params.rnaseq_bbsplit_fasta_list,
        params.star_index,
        params.rsem_index,
        params.salmon_index,
        params.hisat2_index,
    ...
    if (params.rnaseq_trimmer == 'trimgalore') {
        FASTQ_FASTQC_UMITOOLS_TRIMGALORE (
            ...
            params.rnaseq_skip_fastqc || params.rnaseq_skip_qc,
            params.rnaseq_with_umi,
            params.rnaseq_skip_umi_extract,
            params.rnaseq_skip_trimming,
            params.rnaseq_umi_discard_read,
            params.rnaseq_min_trimmed_reads
        )
    ...
    ch_trim_read_count
        .map {
            meta, num_reads ->
                ...
                if (num_reads <= params.rnaseq_min_trimmed_reads.toFloat()) {
    ...
    if (params.rnaseq_aligner == 'star_salmon') {
        ...
        if (params.rnaseq_with_umi) {
            ...
            BAM_DEDUP_STATS_SAMTOOLS_UMITOOLS_GENOME (
                ...
                params.rnaseq_umitools_dedup_stats
            )
    ...
    if (!params.rnaseq_skip_qc) {
        ...
        if (!params.rnaseq_skip_rseqc && rseqc_modules.size() > 0) {
            BAM_RSEQC (
                ch_genome_bam.join(ch_genome_bam_index, by: [0]),
